@echo off
rem NFServerController v2.0 Usage Examples for Windows
rem This script demonstrates the new wildcard pattern matching functionality

echo === NFServerController v2.0 Usage Examples ===
echo.

rem Set the executable path (adjust as needed)
set CONTROLLER=NFServerController.exe
...
echo.
echo Example:
echo MasterServer^|1.13.1.1^|../Install/Config^|../Install/LieRenPlugin^|../Install/LuaScript^|../Install/logs^|LieRen^|../Install/Bin/NFServerStatic.exe^|../Install
echo.
