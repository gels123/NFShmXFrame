...
public:
    virtual int RegisterClientServiceMessage(NF_SERVER_TYPE serverType, uint32_t nMsgID, uint32_t serviceId, bool createCo);
    virtual int RegisterServerServiceMessage(NF_SERVER_TYPE serverType, uint32_t nMsgID, uint32_t serviceId, bool createCo);
