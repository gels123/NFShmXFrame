// -------------------------------------------------------------------------
//    @FileName         :    NFIRedisDriver.h
//    @Author           :    gaoyi
//    @Date             :    23-8-15
//    @Email			:    445267987@qq.com
//    @Module           :    NFIRedisDriver
//
// -------------------------------------------------------------------------
...
#define NFREDIS_DB1     1
#define NFREDIS_DB2     2
#define NFREDIS_DB3     3
#define NFREDIS_DB4     4
#define NFREDIS_DB5     5
#define NFREDIS_DB6     6
#define NFREDIS_DB7     7
#define NFREDIS_DB8     8
#define NFREDIS_DB9     9
#define NFREDIS_DB10    10
#define NFREDIS_DB11    11
#define NFREDIS_DB12    12
#define NFREDIS_DB13    13
#define NFREDIS_DB14    14
...
public:
    ...
    virtual int GetPort() { return mnPort; }
    ...
    */
    ...
    virtual bool KEYS(const std::string& key, std::vector<std::string>& values) = 0;
