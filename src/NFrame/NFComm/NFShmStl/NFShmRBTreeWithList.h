...
public:
    ...
    friend NFShmRBTreeWithListIterator<value_type, reference, pointer, NFShmRBTreeWithList>;
    friend NFShmRBTreeWithListListIterator<value_type, reference, pointer, NFShmRBTreeWithList>;
protected:
